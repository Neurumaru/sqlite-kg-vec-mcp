...
class NodeRepository(ABC):
    ...
    @abstractmethod
    async def find_similar_nodes(self, query_vector: Vector, 
    ...
    @abstractmethod
    async def find_by_date_range(self, start_date: datetime, end_date: datetime) -> List[Node]:
        """
        날짜 범위로 노드를 찾습니다.
    ...
    @abstractmethod
    async def batch_update_embeddings(self, node_embeddings: Dict[NodeId, Vector],
                                    model_name: str) -> int:
        """
