...
def main():
    ...
    parser.add_argument("--db-path", type=str, default="knowledge_graph.db",
                        help="Path to SQLite database file")
    parser.add_argument("--vector-dir", type=str, default="vector_indexes",
    ...
    parser.add_argument("--server-name", type=str, default="Knowledge Graph Server",
                        help="Name of the MCP server")
    parser.add_argument("--server-instructions", type=str, 
