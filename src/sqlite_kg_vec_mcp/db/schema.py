...
class SchemaManager:
    ...
    def _add_json_optimization_columns(self, conn: sqlite3.Connection) -> None:
        ...
        try:
            ...
            warnings.warn(f"Could not add JSON optimization columns: {e}")
    ...
    def backup_schema(self, backup_path: str) -> bool:
        ...
        try:
            ...
            raise sqlite3.Error(f"Backup failed: {e}")
    ...
    def validate_schema(self) -> dict:
        ...
        results = {"valid": True, "errors": [], "warnings": [], "version": version}
        ...
        try:
                ...
                try:
                    ...
                    if integrity != "ok":
                        ...
                        results["errors"].append(
                            f"Integrity check failed for {table}: {integrity}"
                        )
            ...
            errors_list.append(f"Schema validation error: {e}")
        finally:
            conn.close()
