...
from src.common.logging import LoggingConfig, LogLevel, configure_structured_logging
...
class ExampleService:
    ...
    def process_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.logger.info(
            "data_processing_started", input_size=len(data), data_keys=list(data.keys())
        )
...
class ExampleRepository:
    ...
    def save_entity(self, entity_data: Dict[str, Any]) -> str:
        ...
        start_time = self.logger.operation_started(
            "database_save", entity_id=entity_id, entity_type=entity_data.get("type")
        )
        ...
        try:
            ...
            self.logger.operation_completed(
                "database_save", start_time, entity_id=entity_id, table="entities"
            )
