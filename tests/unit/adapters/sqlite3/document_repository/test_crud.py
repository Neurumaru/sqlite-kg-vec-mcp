"""
SQLiteDocumentRepository CRUD 기본 기능 테스트.
"""
...
class TestDocumentRepositoryCrud(unittest.IsolatedAsyncioTestCase):
    """DocumentRepository CRUD 기본 기능 테스트."""
    ...
    async def test_document_already_exists_error_when_save_duplicate(self):
    ...
    async def test_document_not_found_error_when_update_missing(self):
    ...
    async def test_returns_false_when_delete_missing(self):
        """존재하지 않는 문서 삭제 테스트."""
        # Given
    ...
    async def test_returns_true_when_document_exists(self):
    ...
    async def test_returns_false_when_document_not_exists(self):
