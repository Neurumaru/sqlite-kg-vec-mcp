...
class TestEntity(unittest.TestCase):
    ...
    def test_create_entity_without_id_raises_error(self):
        ...
        with self.assertRaises(InvalidEntityException) as context:
            Entity(id=None, entity_type=self.entity_type, name=self.name)
    ...
    def test_create_entity_without_type_raises_error(self):
        ...
        with self.assertRaises(InvalidEntityException) as context:
            Entity(id=self.node_id, entity_type=None, name=self.name)
    ...
    def test_person_entity_without_name_raises_error(self):
        ...
        with self.assertRaises(InvalidEntityException) as context:
            Entity(id=self.node_id, entity_type=EntityType.person(), name=None)
    ...
    def test_organization_entity_without_name_raises_error(self):
        ...
        with self.assertRaises(InvalidEntityException) as context:
            Entity(id=self.node_id, entity_type=EntityType.organization(), name=None)
    ...
    def test_product_entity_without_name_raises_error(self):
        ...
        with self.assertRaises(InvalidEntityException) as context:
            Entity(id=self.node_id, entity_type=EntityType.product(), name=None)
    ...
    def test_concept_entity_can_have_no_name(self):
        ...
        entity = Entity(id=self.node_id, entity_type=EntityType.concept(), name=None)
    ...
    def test_create_factory_method(self):
        ...
        entity = Entity.create(
            entity_type=self.entity_type, name=self.name, properties=self.properties
        )
    ...
    def test_update_name(self):
        ...
        entity = Entity(id=self.node_id, entity_type=self.entity_type, name=self.name)
    ...
    def test_update_name_to_empty_for_required_type_raises_error(self):
        ...
        entity = Entity(
            id=self.node_id, entity_type=EntityType.person(), name=self.name
        )
    ...
    def test_is_same_type(self):
        ...
        entity1 = Entity(
            id=NodeId.generate(), entity_type=EntityType.person(), name="John"
        )

        entity2 = Entity(
            id=NodeId.generate(), entity_type=EntityType.person(), name="Jane"
        )
    ...
    def test_string_representation_without_name(self):
        ...
        entity = Entity(id=self.node_id, entity_type=EntityType.concept())
    ...
    def test_equality(self):
        ...
        entity1 = Entity(id=self.node_id, entity_type=self.entity_type, name="John")
