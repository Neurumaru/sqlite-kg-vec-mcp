...
from src.ports.text_embedder import TextEmbedder, EmbeddingConfig, EmbeddingResult
...
class TestTextEmbedderInterface(unittest.TestCase):
    ...
    def test_abstract_methods_exist(self):
        ...
        expected_methods = {
            'embed_text', 'embed_texts', 'embed_with_metadata', 'batch_embed_with_metadata',
            'get_embedding_dimension', 'get_model_name', 'get_max_token_length',
            'is_available', 'truncate_text', 'compute_similarity', 'find_most_similar',
            'preprocess_text', 'get_embedding_statistics', 'validate_embedding', 'warm_up'
        }
